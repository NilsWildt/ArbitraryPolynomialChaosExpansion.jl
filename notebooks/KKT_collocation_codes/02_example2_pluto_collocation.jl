...
# 	scalefontsizes(2)
# 	xh = LinRange(-1,1,100)
# 	Plots.plot(xh,k_matern_quadratic.(xh;ϵ=0.1),label="Matern quadratic",lw=4,xlabel="x₁-x₂",legend=:bottomleft)
# 	savefig("matern_quad.svg")
# end
...
# ╔═╡ 4e3fe36b-1e02-40d1-beca-c06ddd12597f
