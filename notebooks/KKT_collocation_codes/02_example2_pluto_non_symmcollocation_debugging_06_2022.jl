...
# ╔═╡ 7405a0f5-c851-4e0b-be11-f21ac5e62682
...
md"""
#### Prepare collocation points in Ω and ∂Ω.
"""
...
# ╔═╡ b38d0628-ba81-4ddd-a895-391df1f34481
md"""
#### Problem 1:
$$- \Delta u(\mathbf{x}) + \tau(u(\mathbf{x})) = f(\mathbf{x})$$
$$u(\mathbf{x}) = g(x)$$

with $g(x) = 0$ and $\tau(u(x))=0$ and a given solution for u.

$u(x) = \sin{(\pi x_1)}\cdot \sin{(\pi x_2)} + 4\sin{(4\pi x_1)}\sin{(4\pi x_2)}$

By employing the $\Delta$ operator we get as trace of the hessian:
$$f(x) = -\pi^2\cdot  ( \sin(\pi\cdot x_1)\cdot \sin(\pi\cdot x_2) +64\cdot \sin(4\cdot \pi\cdot x_1)\cdot \sin(4\cdot \pi\cdot x_2) + \sin(\pi\cdot x_1)\cdot$$

$$\sin(\pi\cdot x_2)+64\cdot \sin(4\cdot \pi\cdot x_1)\cdot \sin(4\cdot \pi\cdot x_2))$$

But for now, skipt the nonlinear part.
"""
...
# ╔═╡ fafea49f-9e6f-4074-8ba4-51fac834c194
ε = 1.0
...
#     fig = Figure(resolution = (500, 500), fontsize = 22)

#     ax = Axis3(fig[1, 1], aspect = (1,1,1),viewmode = :stretch, perspectiveness = 0.6, elevation = π / 18,azimuth=π/3,
...
NL2sol = "2fe4ca64-33e0-11e8-0d29-fd842786b1cb"
NLS_Solver = "4f18ef6b-35d7-46eb-a297-26b97f1ff488"
...
git-tree-sha1 = "1b0fbdfc0ad8af4715f6c090de94a582ff48383a"
...
[[deps.NL2sol]]
deps = ["LinearAlgebra", "NL2sol_jll", "Pkg", "Printf", "Random"]
git-tree-sha1 = "d49ba93e0d838dd5c464d721d548104b0d5315af"
uuid = "2fe4ca64-33e0-11e8-0d29-fd842786b1cb"
version = "1.0.0"

[[deps.NL2sol_jll]]
deps = ["CompilerSupportLibraries_jll", "Libdl", "Pkg"]
git-tree-sha1 = "07aba1d06a1e096d8d0bf9a6c53c25cb7038e013"
uuid = "49fe2e30-ebaf-52e2-a844-d04adb473700"
version = "2.2.0+0"

[[deps.NLS_Solver]]
deps = ["ForwardDiff", "LinearAlgebra", "Printf", "ReadOnlyArrays"]
git-tree-sha1 = "f1f687722c3677847d099faf47b7a5e1d20d39f2"
uuid = "4f18ef6b-35d7-46eb-a297-26b97f1ff488"
version = "0.4.1"
