...
@testitem "golden_A_deg1_2D_1out_bayes" begin
    ...
    ref_pred = [0.7056762808770755; 0.5750665794048906; 0.6014073849200607;
...
@testitem "golden_B_deg2_2D_2out_bayes" begin
    ...
    ref_coeffs = [2.473588197261801 2.0361531497864873;
...
@testitem "golden_C_deg2_pinv_only" begin
    ...
    ref_coeffs = [-1.0131865270476204; 2.2361426726088793; -0.9242778017840025;
        -2.384452013308292; 0.22722147860850475; 1.3415170837507602;;]
    ref_pred = [0.4814510925484208; 0.5784528346327067; 0.7012022164932881;
...
@testitem "golden_D_rank_deficient_input" begin
    ...
    ref_pred = [0.4074356641336784; 0.657251632880491; 0.5758685026935618;
