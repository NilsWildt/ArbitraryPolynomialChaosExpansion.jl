...
export run, normalization_functions, aPCE_MultivariatePolynomialDegrees, ∂∂I_aPCE_PsiPolynomialMatrix, RowVecs, ColVecs, GaussianCollocation, train!, predict, UQ, partitionTrainTest, aPCE, aPCE_OrthonormalBasis, create_Polynomial_Degrees, create_basis,
	evaluate_Ψ, train!
