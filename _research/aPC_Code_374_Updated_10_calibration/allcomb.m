...
error(nargchk(1,Inf,nargin)) ; %nargchk(LOW,HIGH,N) returns an appropriate error message if N is not between LOW and HIGH
...
if ni==0,
    ...
    if ni==1,
        ...
        l=length(A); % number of combinations ( N=Number of parameters vs dd= Degrees of polynomials of root differentiation)
    end
end
