...
for inp = 1:F*P
    ...
    move_input = strcat('cp column8.input Simulation',num2str(inp));
    system(move_input);
    move_exec = strcat('cp micp Simulation',num2str(inp));
    system(move_exec);
    move_inj = strcat('cp Column8Inj.dat Simulation',num2str(inp));
    system(move_inj);
